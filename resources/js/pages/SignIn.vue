...
<template>
  <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
    <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
      ...
      <div class="relative hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2 url-b">
        ...
        <div class="flex items-center justify-center z-1">
          ...
          <div class="w-full max-w-md pt-10">
            <a href="index.html"
              class="absolute top-4 left-4 inline-flex items-center text-sm text-white transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 z-10">
          ...
          <img class="w-full h-full object-cover relative"
            src="https://images.unsplash.com/photo-1540563283646-b6e0f4762a5f?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="">
            ...
            <div>
              ...
              <form @submit.prevent='submitLogin'>
                <div class="space-y-5">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <span @click="showPassword = !showPassword"
                        ...
                        <svg v-show="!showPassword" class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <div>
                    <button type='submit'
                      class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium bg-blue-600 text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                      Sign In
                    </button>
                  </div>
                </div>
