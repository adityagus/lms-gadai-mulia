<template>
  ...
  <section id="CourseInfo" class="flex gap-[50px]">
    ...
    <AnimatedPlaceholder width='480px' height='250px' borderRadius='20px' id="Thumbnail" v-if='!course?.thumbnail_url' class="flex shrink-0 bg-[#D9D9D9] overflow-hidden"/>
    
    <div id="Thumbnail" v-else class="flex shrink-0 w-[480px] h-[250px] rounded-[20px] bg-[#D9D9D9] overflow-hidden">
